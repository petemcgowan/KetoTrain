        ...
        {slides.map((slide, index) => {
          ...
          return (
            <SlideComponent
              ...
              referenceSource={slide.referenceSource}
            />
          )
        })}
      </ScrollView>
